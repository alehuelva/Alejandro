 ...
 */
        ...
        $enquiry = new Enquiry(); 		//Creating a new enquiry with all fields to fill in for sending mail
	    $form = $this->createForm(new EnquiryType(), $enquiry); 		//Creating a form and keeping dates in $enquiry
